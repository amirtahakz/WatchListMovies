...
namespace WatchListMovies.Infrastructure.Migrations
{
    ...
    [Migration("20250531115749_InitDb")]
            ...
            modelBuilder.Entity("WatchListMovies.Domain.CastAgg.Cast", b =>
                {
                    ...
                    b.OwnsMany("WatchListMovies.Domain.CastAgg.ValueObjects.CastKnownForValueObject", "CastKnownFors", b1 =>
                        {
                            b1.Property<Guid>("CastId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsMany("WatchListMovies.Domain._Shared.ValueObjects.GenreValueObject", "CastKnownForGenreIds", b2 =>
                                {
                    ...
                    b.OwnsOne("WatchListMovies.Domain.MovieAgg.MovieDetail", "MovieDetails", b1 =>
                        {
                            ...
                            b1.OwnsMany("WatchListMovies.Domain._Shared.ValueObjects.GenreValueObject", "Genres", b2 =>
                                {
                                    b2.Property<DateTime>("CreationDate")
                                        .HasColumnType("datetime2");
                            ...
                            b1.OwnsMany("WatchListMovies.Domain.MovieAgg.MovieCast", "Casts", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsMany("WatchListMovies.Domain.MovieAgg.MovieCrew", "Crews", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier");
