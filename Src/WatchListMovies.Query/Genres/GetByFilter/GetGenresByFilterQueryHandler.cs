...
using WatchListMovies.Query.Genres;
...
{
    public class GetGenresByFilterQueryHandler : IQueryHandler<GetGenresByFilterQuery, GenreFilterResult>
    {
        private readonly ApplicationDbContext _context;

        public GetGenresByFilterQueryHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<GenreFilterResult> Handle(GetGenresByFilterQuery request, CancellationToken cancellationToken)
        {
