...
public class GetListsByFilterQueryHandler : IQueryHandler<GetListsByFilterQuery, ListFilterResult>
{
    private readonly ApplicationDbContext _context;

    public GetListsByFilterQueryHandler(ApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<ListFilterResult> Handle(GetListsByFilterQuery request, CancellationToken cancellationToken)
    {
